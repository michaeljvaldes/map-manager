...
function addProducts(b) {
    ...
    b.tag("#product").artificial().blocking().apply((b) => {
    ...
    b.tag("#product").artificial().nonblocking().apply((b) => {
...
function addProductMaterials(b) {
    b.tag("#wooden").apply([
        ...
        "*:*wooden_*",
        "*:*_wood !#natural",
        "planks, fence_gate, fence, wall_banner, wall_sign"
    ]).artificial();
